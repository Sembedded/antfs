/*
 * device.h - Exports for low level device io.
...
struct ntfs_device_operations {
	...
	int (*close) (struct ntfs_device *dev);
	 ...
	 s64(*pread) (struct ntfs_device *dev, void *buf, s64 count,
		      s64 offset);
...
extern s64 ntfs_cluster_read(const struct ntfs_volume *vol, const s64 lcn,
			     const s64 count, void *b);
extern s64 ntfs_cluster_write(const struct ntfs_volume *vol, const s64 lcn,
